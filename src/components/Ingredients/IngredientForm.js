      ...
      <Card>
        <form onSubmit={submitHandler}>
          <div className="form-control">
            ...
            <input type="text" id="title" value={ingredientsTitle} onChange={ event => {
                setIngredientsTitle(event.target.value)}
              }/>
          </div>
          <div className="form-control">
            <label htmlFor="amount">Amount</label>
            <input type="number" id="amount" value={ingredientsAmount} onChange = { event => {
